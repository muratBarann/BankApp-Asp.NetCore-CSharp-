...
namespace BankApp.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        //public AccountController(IApplicationUserRepository applicationUserRepository, IUserMapper userMapper, IAccountRepository accountRepository)
        //{
        ...
        [HttpPost]
        public IActionResult SendMoney(SendMoneyModels model)
        {
            //SenderId
            //AccountId
